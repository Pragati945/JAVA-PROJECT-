...
/**
 * NavigationGUI — Swing frontend for the Dehradun Navigation System.
 *
 * Drop this file alongside Main.java (same default package) and compile
 * everything together. Run with:
 *   javac -cp .:mysql-connector.jar $(find . -name "*.java") && java -cp .:mysql-connector.jar NavigationGUI
 *
 * All DB / logic classes remain untouched.
 */
public class NavigationGUI extends JFrame {
    ...
    // ── Right panel (graph canvas + table) ────────────────────────────────────
...
for (JComboBox<String> cb : combos) {
  ...
  private void styleCombo(JComboBox<String> cb) {
    ...
    // Fix the editor (selected item shown when closed)
    cb.setEditable(true);
...
cb.setEditor(new BasicComboBoxEditor() {
...

    {
        ...
        label.setBackground(Color.WHITE);  // BOX COLOR
    ...
    // ═════════════════════════════════════════════════════════════════════════
    // GraphPanel — custom canvas that draws nodes + edges
    // ═════════════════════════════════════════════════════════════════════════
